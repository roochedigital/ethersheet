...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="NocoDB" src="~/assets/img/brand/logo.svg" />
      <img class="dark:hidden" :width="size" :height="size" alt="NocoDB" src="~/assets/img/brand/logo.svg" />
