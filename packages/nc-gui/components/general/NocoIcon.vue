...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="NocoDB" src="~/assets/img/icons/logo_icon.svg" />
      <img class="dark:hidden" :width="size" :height="size" alt="NocoDB" src="~/assets/img/icons/logo_icon.svg" />
